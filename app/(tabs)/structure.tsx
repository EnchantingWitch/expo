...
const Struct = () => {
  ...
  const getStructure = async () => {
    ...
    const renderSectionHeader=({ section}: {section: Structure}) => (
      ...
      <View style={{flexDirection: 'row', backgroundColor: '#E0F2FE', width: '96%', height: 37,   marginBottom: '3%', marginTop: '2%', alignItems: 'center', borderRadius: 8, alignSelf: 'center'}}>
    ...
    const renderItem = ({section, item }: { section: id , item: data }) => {
      ...
      return(
      <TouchableOpacity onPress={() =>router.push({pathname: '/structures/system', params: { post: item.pnrsystemId, codeCCS: codeCCS, capitalCSName: capitalCSName, ii:  item.numberII}})} style={{width: '98.5%'}}>
    ...
    <View style={{ backgroundColor: 'white', flex: 1 }}>
        <HeaderForTabs nameTab='Структура' capitalCSName={capitalCSName}/>
