...
const PiechartSmall = ({ totalQuantity, blueQuantity, greenQuantity, redQuantity, title, submitted }: Props) => {
  ...
  const pieData = [
  {
    value: totalQuantity-blueQuantity-redQuantity,
    color: '#A9A9A9',
  ...
  return (
    <>
      <View
        ...
        <View style={{ height: 20, width: '32%', }}>
         {/* {renderDot('#006DFF')}*/}
          <Text style={{color: '#A9A9A9', fontSize: ts(16.7), alignSelf: 'center'}}>{totalQuantity-blueQuantity} </Text>{/** здесь над подставить вычисленную разницу */}
          <Text style={{ fontSize: ts(9.3), alignSelf: 'center'}}>осталось</Text>
        </View>
        <View style={{  height: 20, width: '32%'}}>
           {/* {renderDot('#8F80F3')}*/}
          <Text style={{color: '#2FB4E9', fontSize: ts(16.7), alignSelf: 'center'}}>{submitted} </Text>{/** здесь над подставить вычисленную сумму green+blue */}
    ...
    <View
      ...
      <View style={{padding: 2, alignItems: 'center'}}>
        <PieChart
          ...
          initialAngle={
            totalQuantity-blueQuantity-redQuantity===0? 0:
