...
const PiechartBig = ({ totalQuantity, blueQuantity, greenQuantity, redQuantity, submitted, title }: Props) => {
  ...
  const pieData = [
  {
    value: totalQuantity-blueQuantity-redQuantity,//осталось сколько до тотал
    color: '#A9A9A9',
    ...
    <View
      ...
      <View style={{padding: 2, alignItems: 'center'}}>
        <PieChart
          ...
          //initialAngle={(((totalQuantity-blueQuantity-redQuantity)*360/totalQuantity)/180*Math.PI +360/180*Math.PI)} уезжает против часовой стрелки на долю занимаемой области
          //initialAngle={-(totalQuantity-blueQuantity-greenQuantity-redQuantity) } //
